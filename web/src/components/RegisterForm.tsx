...
export default function RegisterForm() {
  ...
  return (
    <div className="mx-auto mt-10 max-w-sm rounded-xl border bg-white p-6 shadow-sm">
      ...
      <p className="mt-1 text-sm text-zinc-500">Create an account using your Person ID.</p>

      {error && <div className="mt-4 rounded bg-red-50 p-3 text-sm text-red-700">{error}</div>}

      <form onSubmit={handleRegister} className="mt-6 space-y-4">
        <div>
          <label htmlFor="reg-username" className="block text-sm font-medium text-zinc-700">Username</label>
          <input
            id="reg-username"
            type="text"
            required
        ...
        <div>
          <label htmlFor="reg-password" className="block text-sm font-medium text-zinc-700">Password</label>
          <input
            id="reg-password"
            type="password"
            required
        ...
        <div>
          <label htmlFor="reg-personid" className="block text-sm font-medium text-zinc-700">Person ID (UUID)</label>
          <input
            id="reg-personid"
            type="text"
            required
            ...
            className="mt-1 block w-full rounded-md border border-zinc-300 px-3 py-2 shadow-sm focus:border-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500 sm:text-sm font-mono"
      ...
      <div className="mt-4 text-center text-sm">
        <a href="/login" className="text-zinc-600 hover:underline">Already have an account? Sign in</a>
      </div>
    </div>
  );
}
